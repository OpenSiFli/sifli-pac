...
impl TsenCtrlReg {
    ...
    #[doc = "power up tsen"]
    #[inline(always)]
    pub const fn set_anau_tsen_pu(&mut self, val: bool) {
    ...
    #[doc = "resetb for tsen"]
    #[inline(always)]
    pub const fn set_anau_tsen_rstb(&mut self, val: bool) {
    ...
    #[doc = "enable tsen run"]
    #[inline(always)]
    pub const fn set_anau_tsen_run(&mut self, val: bool) {
    ...
    #[doc = "bias current selection to tune vba"]
    #[inline(always)]
    pub const fn set_anau_tsen_ig_vbe(&mut self, val: u8) {
    ...
    #[doc = "select internal clock frequency"]
    #[inline(always)]
    pub const fn set_anau_tsen_fck_sel(&mut self, val: u8) {
    ...
    #[doc = "signature-mode enable"]
    #[inline(always)]
    pub const fn set_anau_tsen_sgn_en(&mut self, val: bool) {
    ...
    #[doc = "serial-parallel output selection"]
    #[inline(always)]
    pub const fn set_anau_tsen_ser_par_sel(&mut self, val: bool) {
    ...
    #[doc = "tsen ready"]
    #[inline(always)]
    pub const fn set_anau_tsen_rdy(&mut self, val: bool) {
    ...
    #[doc = "Enable tsen digital module"]
    #[inline(always)]
    pub const fn set_anau_tsen_en(&mut self, val: bool) {
    ...
    #[doc = "gen tsen clk by divide hclk by anau_tsen_clk_div"]
    #[inline(always)]
    pub const fn set_anau_tsen_clk_div(&mut self, val: u8) {
...
impl TsenIrq {
    ...
    #[inline(always)]
    pub const fn set_tsen_icr(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_tsen_imr(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_tsen_irsr(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_tsen_isr(&mut self, val: bool) {
...
impl TsenRdata {
    ...
    #[inline(always)]
    pub const fn set_tsen_rdata(&mut self, val: u16) {
