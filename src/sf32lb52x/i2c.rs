...
impl I2c {
    ...
    #[inline(always)]
    pub const fn dbr(self) -> crate::common::Reg<u32, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn lcr(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x18usize) as _) }
    }
    #[doc = "Wait Count Register"]
    #[inline(always)]
    pub const fn wcr(self) -> crate::common::Reg<u32, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn bmr(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x24usize) as _) }
    }
    #[doc = "DMA number register"]
    #[inline(always)]
    pub const fn dnr(self) -> crate::common::Reg<u32, crate::common::RW> {
