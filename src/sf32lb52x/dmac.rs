...
impl Dmac {
    ...
    pub const fn ccr(self, n: usize) -> crate::common::Reg<regs::Ccr, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x08usize + n * 20usize) as _) }
    }
    #[inline(always)]
    pub const fn cndtr(self, n: usize) -> crate::common::Reg<regs::Cndtr, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize + n * 20usize) as _) }
    }
    #[inline(always)]
    pub const fn cpar(self, n: usize) -> crate::common::Reg<regs::Cpar, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x10usize + n * 20usize) as _) }
    }
    #[inline(always)]
    pub const fn cm0ar(self, n: usize) -> crate::common::Reg<regs::Cm0ar, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x14usize + n * 20usize) as _) }
    }
    #[inline(always)]
    pub const fn cbsr(self, n: usize) -> crate::common::Reg<regs::Cbsr, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x18usize + n * 20usize) as _) }
    }
    #[inline(always)]
    pub const fn cselr(self, n: usize) -> crate::common::Reg<regs::Cselr, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xa8usize + n * 4usize) as _) }
    }
}
pub mod regs;
pub mod vals;
