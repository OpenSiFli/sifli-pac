...
impl Atim {
    ...
    #[inline(always)]
    pub const fn bdtr(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x44usize) as _) }
    }
    #[doc = "TIM capture/compare mode register 3"]
    #[inline(always)]
    pub const fn ccmr3(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x54usize) as _) }
    }
    #[doc = "Capture/Compare register 5"]
    #[inline(always)]
    pub const fn ccr5(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x58usize) as _) }
    }
    #[doc = "Capture/Compare register 6"]
    #[inline(always)]
    pub const fn ccr6(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x5cusize) as _) }
    }
    #[doc = "Alternate function option register"]
    #[inline(always)]
    pub const fn af1(self) -> crate::common::Reg<u32, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(0x60usize) as _) }
    }
    #[doc = "Alternate function option register 2"]
    #[inline(always)]
    pub const fn af2(self) -> crate::common::Reg<u32, crate::common::RW> {
